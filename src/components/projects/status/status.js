...
const status = ({ status }) => {
    ...
    if (status === 'online') {
        printedStatus = (
            <div className="inline">
                <span className="relative inline-flex h-3 w-3">
                    <span className="animate-ping absolute inline-flex h-full w-full my-auto rounded-full bg-green-400 opacity-75"></span>
        ...
        printedStatus = (
            <div className="inline">
                <span className="relative inline-flex h-3 w-3">
                    <span className="animate-ping absolute inline-flex h-full w-full my-auto rounded-full bg-red-400 opacity-75"></span>
        ...
        printedStatus = (
            <div className="inline">
                <span className="relative inline-flex h-3 w-3">
                    ...
                    <span className="animate-ping absolute inline-flex h-full w-full my-auto rounded-full bg-yellow-400 opacity-75"></span>
                </span>
